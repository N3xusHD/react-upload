var MediaInfoLib = (function () {
  ...
  return function (MediaInfoLib) {
    MediaInfoLib = MediaInfoLib || {};

    var Module = typeof MediaInfoLib !== "undefined" ? MediaInfoLib : {};
    ...
    var wasmBinaryFile = "https://mediaarea.net/_/js/MediaInfoWasm-21.03.wasm";
    /*
    ...
    */
        ...
        var processChunk = function (e) {
          if (e.target.error === null) {
            ...
            if (seekTo === -1) {
              ...
              offset = seekTo;
              _this.Open_Buffer_Init(file.size, seekTo);
            }
          } else {
            typeof callback === "function" && callback();
            return;
          }
          if (state & 8 || e.target.result.byteLength < 1) {
    ...
    return MediaInfoLib.ready;
  };
})();
export default MediaInfoLib;
